...
import com.example.excption.CustomAccessDeniedHandler;
import com.example.excption.CustomAuthExceptionEntryPoint;
import com.example.voter.FangxAccessDecisionVoter;
import com.example.voter.RoleBasedVoter;
...
//    }
    ...
    @Bean
    public FangxAccessDecisionVoter FangxAccessDecisionVoter (){
        return new FangxAccessDecisionVoter();
    }
